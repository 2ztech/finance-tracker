...
$commitmentsTotal = Expense::getCommitmentsRemaining();
...
$projectedBalance = ($startingBalance + $allIncome) - ($allExpense + $commitmentsTotal);
...
<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-dark-800/80 backdrop-blur-md rounded-2xl p-6 border border-dark-700/50 shadow-lg relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
            ...
            <p class="text-sm font-medium text-gray-400 mb-2">Current Real Balance</p>
